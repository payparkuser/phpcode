...
class UserPaymentNotificationJob implements ShouldQueue
{
   ...
   /**
    ...
    public function handle()
    {
        try {
            ...
            $title = $content = Helper::push_message(610);

            $data['space_id'] = $booking_details['host_id'];

            $data['notification_type'] = BELL_NOTIFICATION_TYPE_BOOKING_PAYMENT;
