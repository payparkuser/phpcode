...
class SpaceApproveJob implements ShouldQueue
{
    ...
    */
    ...
    public function handle()
    {
       try {
            ...
            $data['notification_type'] = BELL_NOTIFICATION_TYPE_SPACE_APPROVED;
            ...
            if (Setting::get('is_email_notification') == YES) {
                ...
                $email_data['subject'] = Setting::get('site_name').' '.tr('host_approve_title');
