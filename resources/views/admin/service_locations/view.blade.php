                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="custom-card">
                            ...
                            <p class="card-text">{{ common_date($service_location_details->updated_at,Auth::guard('admin')->user()->timezone) }}</p>
                        ...
                        <div class="custom-card">
                            ...
                            <p class="card-text">{{ common_date($service_location_details->created_at,Auth::guard('admin')->user()->timezone) }}</p>
